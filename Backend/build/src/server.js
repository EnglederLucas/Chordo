...
const port = parseInt((_a = process.env["PORT"], (_a !== null && _a !== void 0 ? _a : "0"))) || 3030;
...
async function init() {
    ...
    await mongoose_1.default.connect((_a = process.env["MONGODB_CONNECTION"], (_a !== null && _a !== void 0 ? _a : "")), { useNewUrlParser: true, useUnifiedTopology: true }, (err) => {
        if (err) {
